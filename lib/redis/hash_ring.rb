...
class Redis
  class HashRing
    ...
    # returns a hash, sorted from least to greatest, of nodes to the percentage of
    # the hashspace they cover. useful for tweaking the replicas and digest parameters
    # in order to achieve a more even distribution of keys among nodes
    def statistics
      result = Hash.new(0)
      last = 0
