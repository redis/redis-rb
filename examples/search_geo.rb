...
# Redis Search Geospatial Query Example
#
# This example demonstrates geospatial search capabilities in Redis Search including:
# - Creating a search index with geo and geoshape fields
# - Searching within a radius using geo fields
# - Searching with geoshape CONTAINS queries
# - Searching with geoshape WITHIN queries
# - Combining geo filters with other filters
#
# Run this example with: ruby examples/search_geo.rb
...
# Create index with geo and geoshape fields
...
puts "=== Geospatial Search Examples ==="
